    ...
    <footer>
      <div className="mt-16 flex flex-col items-center">
        ...
        <div className="mb-2 flex text-sm text-gray-500 dark:text-gray-400">
          <p className="px-2">Développé avec </p>
          <div className="flex space-x-2 dark:stroke-gray-400 dark:fill-gray-400">
            <svg
            ...
            <svg className="h-6 w-16" viewBox="0 0 394 80" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 54 33">
