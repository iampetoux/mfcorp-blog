...
const Header = () => {
  return (
    <header className="supports-backdrop-blur:bg-white/95 sticky top-0 z-40 py-3 backdrop-blur dark:bg-grey-900 border-b border-gray-100 dark:border-gray-800">
